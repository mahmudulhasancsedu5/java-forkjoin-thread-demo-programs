	...
	static class Schur extends RecursiveAction {
		...
		protected void compute() {
			if (size == BLOCK_SIZE) {
				...
				ForkJoinTask[] seq1 = { new Schur(h, V00, W00, M00), new Schur(h, V01, W10, M00) };
				ForkJoinTask[] seq2 = { new Schur(h, V00, W01, M01), new Schur(h, V01, W11, M01) };
				ForkJoinTask[] seq3 = { new Schur(h, V10, W00, M10), new Schur(h, V11, W10, M10) };
				ForkJoinTask[] seq4 = { new Schur(h, V10, W01, M11), new Schur(h, V11, W11, M11) };
	...
	static class Lower extends RecursiveAction {
		...
		protected void compute() {
			if (size == BLOCK_SIZE) {
				...
				ForkJoinTask[] seq1 = { new Lower(h, L00, M00), new Schur(h, L10, M00, M10), new Lower(h, L11, M10) };
				ForkJoinTask[] seq2 = { new Lower(h, L00, M01), new Schur(h, L10, M01, M11), new Lower(h, L11, M11) };
	...
	static class Upper extends RecursiveAction {
		...
		protected void compute() {
			if (size == BLOCK_SIZE) {
				...
				ForkJoinTask[] seq1 = { new Upper(h, U00, M00), new Schur(h, M00, U01, M01), new Upper(h, U11, M01) };
				ForkJoinTask[] seq2 = { new Upper(h, U00, M10), new Schur(h, M10, U01, M11), new Upper(h, U11, M11) };
	...
	static class LowerUpper extends RecursiveAction {
		...
		protected void compute() {
			if (size == BLOCK_SIZE) {
				...
				invokeAll(new Lower(h, M00, M01), new Upper(h, M00, M10));
