...
public class MatrixMultiply {
	...
	public static void main(String[] args) {
		...
		try {
			...
			// check if matrix multiplication is accurate
//			check(c, n);
...
//			System.out.println("Thread:  " + Thread.currentThread().getId());
			...
			if (size <= granularity) {
				...
				ForkJoinTask[] seq1 = { new Multiplier(A, aRow, aCol, // A11
						B, bRow, bCol, // B11
						C, cRow, cCol, // C11
						h),
				...
				ForkJoinTask[] seq2 = { new Multiplier(A, aRow, aCol, // A11
						B, bRow, bCol + h, // B12
						C, cRow, cCol + h, // C12
						h),
						new Multiplier(A, aRow, aCol + h, // A12
				...
				ForkJoinTask[] seq3 = { new Multiplier(A, aRow + h, aCol, // A21
						B, bRow, bCol, // B11
						C, cRow + h, cCol, // C21
						h),
				...
				ForkJoinTask[] seq4 = { new Multiplier(A, aRow + h, aCol, // A21
						B, bRow, bCol + h, // B12
						C, cRow + h, cCol + h, // C22
						h),
						new Multiplier(A, aRow + h, aCol + h, // A22
